...
Not a search (that's find — searches content across walnuts). History searches SESSIONS — what squirrels did, what was discussed, what was decided. For deep context extraction from source material, use `alive:mine`.
...
When history finds sessions with rich, unmined context — long sessions, many stash items, transcripts with extensive research or decision-making — suggest escalation to `alive:mine`:
...
- Not `alive:find` — find searches content across walnuts. History searches sessions.
- Not `alive:tidy` — tidy surfaces broken things. History surfaces past context.
- Not `alive:mine` — mine does deep extraction from source material. History is the lighter "what happened recently?"
