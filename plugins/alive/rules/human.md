...
8. **Stash in conversation, route at save.** Don't write to walnut files mid-session (except capture + capsule work). Saving means running `alive:save` — never freestyle save operations from rule knowledge.
